<?php
    if (isset($_POST["submit"])) {
        ...
        $subject = 'Vivre et Aimer Bericht van '.$name;
        ...
        if (!$_POST['email'] || !filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
            $errEmail = 'Voer een geldige email adres in';
        }

        //Check if message has been entered
        if (!$_POST['message']) {
            $errMessage = 'Voer een bericht in';
        }

// If there are no errors, send the email
if (!$errName && !$errEmail && !$errMessage) {
    if (mail ($to, $subject, $body, $from)) {
        $result='<div class="alert alert-success">Dank u, ik beantwoord zo snel mogelijk</div>';
    } else {
        $result='<div class="alert alert-danger">Sorry, er is iets mis gegaan. Probeer later nog een keer, of email mij apart.</div>';
    }
}
    }
?>
 ...
 <script src="../js/contact_me.js"></script>
   ...
   <nav class="navbar navbar-default">
    ...
    <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Talen <i class="fa fa-globe"></i><b class="caret"></b></a>
    ...
    <div class="container-fluid">
      ...
      <div class = "row">
        <div class="col-md-6 col-md-offset-6">
          <h2 class = "tag-line2">Kan gerust via</h2>
        </div>
      </div>
    </div>
  </div>
 ...
 <div id="contacts" style="margin-top:20px;">
  ...
  <div class="col-sm-offset-3 col-sm-6">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="name" name="name" placeholder="Voor &amp; Achter Naam" value="<?php echo htmlspecialchars($_POST['name']); ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="email" class="form-control" id="email" name="email" placeholder="voorbeeld@domain.com" value="<?php echo htmlspecialchars($_POST['email']); ?>">
